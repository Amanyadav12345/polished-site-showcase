...
export const Projects = () => {
  ...
  return <section id="projects" className="py-24 bg-gradient-to-br from-red-50 via-orange-50 to-red-100 dark:from-red-950/10 dark:via-orange-950/10 dark:to-red-950/20 relative overflow-hidden">
      {/* Animated background elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-1/4 w-32 h-32 bg-orange-400/10 rounded-full animate-float"></div>
        <div className="absolute top-1/3 right-1/5 w-24 h-24 bg-red-400/15 rounded-full animate-bounce-slow" style={{
        animationDelay: '1s'
      }}></div>
        <div className="absolute bottom-1/4 left-1/6 w-20 h-20 bg-orange-300/20 rounded-full animate-pulse"></div>
        <div className="absolute bottom-1/3 right-1/4 w-28 h-28 bg-red-300/10 rounded-full animate-float" style={{
        animationDelay: '2s'
      }}></div>
        <div className="absolute top-1/2 left-1/12 w-16 h-16 bg-orange-500/15 rounded-full animate-bounce-slow" style={{
        animationDelay: '3s'
      }}></div>
        <div className="absolute top-3/4 right-1/3 w-14 h-14 bg-red-500/20 rounded-full animate-float" style={{
        animationDelay: '1.5s'
      }}></div>
        ...
        <div className="absolute -bottom-20 -right-20 w-48 h-48 bg-gradient-to-br from-red-400/15 to-orange-500/15 rounded-full blur-xl animate-bounce-slow" style={{
        animationDelay: '2.5s'
      }}></div>
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => <Card key={project.title} className="group hover:shadow-2xl hover:shadow-orange-500/25 transition-all duration-500 hover:-translate-y-2 bg-card/80 backdrop-blur-sm border-orange-200/50 dark:border-orange-800/50 animate-fade-in" style={{
          animationDelay: `${index * 0.1}s`
              ...
              <CardContent>
                <div className="flex flex-wrap gap-2">
                  {project.tech.map(tech => <Badge key={tech} variant="outline" className="border-orange-400/30 text-orange-600 dark:text-orange-400 hover:bg-gradient-to-r hover:from-orange-500 hover:to-red-500 hover:text-white transition-all duration-300">
                      {tech}
                    </Badge>)}
                </div>
              </CardContent>
