...
export const About = () => {
  const skills = ["Java", "Python", "JavaScript", "TypeScript", "React.js", "Angular", "Node.js", "Spring Boot", "Flutter", "Django", "MySQL", "PostgreSQL", "MongoDB", "TensorFlow", "PyTorch", "Hugging Face", "LangChain", "Mistral", "TinyLLaMA", "RAG", "NLP", "Docker", "REST APIs"];
  return <section id="about" className="py-24 bg-gradient-to-br from-orange-50 via-red-50 to-orange-100 dark:from-orange-950/20 dark:via-red-950/20 dark:to-orange-950/30 relative overflow-hidden">
      {/* Animated background elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-10 left-10 w-20 h-20 bg-orange-400/20 rounded-full animate-bounce-slow"></div>
        <div className="absolute top-32 right-20 w-16 h-16 bg-red-400/20 rounded-full animate-float" style={{
        animationDelay: '1s'
      }}></div>
        <div className="absolute bottom-20 left-1/4 w-12 h-12 bg-orange-300/30 rounded-full animate-pulse"></div>
        <div className="absolute bottom-40 right-1/3 w-24 h-24 bg-red-300/20 rounded-full animate-float" style={{
        animationDelay: '2s'
      }}></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative group">
              ...
              <div className="w-80 h-80 mx-auto bg-gradient-to-br from-orange-400 via-red-500 to-orange-600 rounded-3xl p-3 shadow-2xl shadow-orange-500/25 transform hover:scale-105 transition-all duration-500">
                <div className="w-full h-full rounded-2xl bg-gradient-to-br from-orange-100 to-red-100 dark:from-orange-900/50 dark:to-red-900/50 flex items-center justify-center text-2xl font-bold text-orange-600 dark:text-orange-400 border-4 border-white dark:border-orange-950/50 overflow-hidden">
                  <img alt="Aman Yadav - Full Stack Developer" src="/lovable-uploads/294c9ebe-cdef-4e55-9b2d-128155cf2dce.png" className="object-scale-down" />
                </div>
              </div>
              ...
              <div className="absolute -top-4 -right-12 w-20 h-20 bg-gradient-to-br from-red-400 to-orange-500 rounded-full flex items-center justify-center shadow-lg animate-float" style={{
              animationDelay: '0.5s'
            }}>
              ...
              <div className="absolute -bottom-4 -left-12 w-16 h-16 bg-gradient-to-br from-red-500 to-orange-400 rounded-full flex items-center justify-center shadow-lg animate-float" style={{
              animationDelay: '1.5s'
            }}>
                <Heart className="w-8 h-8 text-white" />
              </div>
              
              <div className="absolute top-1/2 -left-16 w-14 h-14 bg-gradient-to-br from-orange-300 to-red-400 rounded-full flex items-center justify-center shadow-lg animate-bounce-slow" style={{
              animationDelay: '2s'
            }}>
                <Coffee className="w-6 h-6 text-white" />
              </div>
              
              <div className="absolute top-1/4 -right-16 w-12 h-12 bg-gradient-to-br from-red-300 to-orange-300 rounded-full flex items-center justify-center shadow-lg animate-float" style={{
              animationDelay: '2.5s'
            }}>
          ...
          animationDelay: '0.3s'
            ...
            <div className="space-y-8">
              ...
              {/* Stats Cards */}
              <div className="grid grid-cols-2 gap-4 my-8 animate-fade-in" style={{
              animationDelay: '1.1s'
            }}>
              ...
              animationDelay: '1.25s'
                ...
                <div className="flex flex-wrap gap-2">
                  {["Full Stack Development", "GenAI & RAG", "Healthcare AI", "Microservices", "Test Automation"].map((spec, index) => <Badge key={spec} variant="outline" className="px-3 py-1 text-xs font-inter bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-800 hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-all duration-300">
                      {spec}
                    </Badge>)}
                </div>
              </div>
              ...
              animationDelay: '1.3s'
                ...
                <div className="flex flex-wrap gap-3">
                  {skills.map((skill, index) => <Badge key={skill} variant="secondary" className="px-4 py-2 text-sm font-inter bg-gradient-to-r from-orange-100 to-red-100 dark:from-orange-900/30 dark:to-red-900/30 text-orange-700 dark:text-orange-300 hover:from-orange-500 hover:to-red-500 hover:text-white transition-all duration-300 transform hover:scale-110 animate-slide-in border border-orange-200 dark:border-orange-800" style={{
